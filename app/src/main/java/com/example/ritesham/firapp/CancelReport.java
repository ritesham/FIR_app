...
public class CancelReport extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cancelReport=findViewById(R.id.btnDltFir);
        ...
        cancelReport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference myRef = database.getReference("Reports Table").child(VictimLogin.sID);
                myRef.removeValue();
                Toast.makeText(getApplicationContext(),"This report has been deleted!",Toast.LENGTH_LONG).show();
