...
public class ReportsDetailsDialog extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_reports_details_dialog);
        ...
        rejectBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatabaseReference myRef = database.getReference("Reports Table").child(usr);
                String status="REJECTED";

                myRef.child("Status").setValue(status);
                Toast.makeText(getApplicationContext(),"This report has been rejected!",Toast.LENGTH_LONG).show();
        ...
        actionBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                myRef.child("Status").setValue(status);
                Toast.makeText(getApplicationContext(),"This report has been forwarded!",Toast.LENGTH_LONG).show();
